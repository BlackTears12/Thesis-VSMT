...
Control {
    id: control
    property GaugeStyle gaugeStyle
    ...
    */
    property Component tickmark: Rectangle {
        width: outerRadius * gaugeStyle.tickmarkWidthMultiplier
        height: outerRadius * gaugeStyle.tickmarkHeightMultiplier
        visible: gaugeStyle.tickmarkVisible
        antialiasing: true

        color: Utils.rotationToValue(needleRotation,maximumValue) >= styleData.value ? gaugeStyle.tickActivatedColor
            : styleData.value >= maximumValue - gaugeStyle.alertThreshold ? gaugeStyle.tickAlertColor : gaugeStyle.tickColor
    }
    ...
    */
    property Component minorTickmark: Rectangle {
        width: outerRadius * gaugeStyle.minorTickmarkWidthMultiplier
        height: outerRadius * gaugeStyle.minorTickmarkHeightMultiplier
        visible: gaugeStyle.minorTickmarkVisible
        antialiasing: true
