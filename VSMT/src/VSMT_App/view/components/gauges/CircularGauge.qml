...
Control {
    ...
    required property GaugeStyle gaugeStyle
    ...
    Connections {
        target: panelItem.circularTickmarkLabel
        function onClicked() { control.clicked() }
    }
    ...
    /*
        Target of value change animation
    */
    ...
    */
    property real minimumValueAngle: -gaugeStyle.valueAngle
    ...
    /*!
        ...
        The default value is \c 145.
    */
    property real maximumValueAngle: gaugeStyle.valueAngle
    ...
    */
    ...
    /*!
        ...
        \sa tickmarkCount
    */
    property int minorTickmarkCount: 20

    /*!
        The distance in pixels from the outside of the gauge (outerRadius) at
        which the outermost point of the minor tickmark line is drawn.
    */
    property real minorTickmarkInset: 3
   ...
   property Component gaugeBackground: Rectangle {
        ...
        opacity: panelItem.circularTickmarkLabel.hovering ? 1 : 0
    }
    ...
    */
    property Component foreground: Item {
        ...
        Rectangle{
            anchors.centerIn: parent
            color: gaugeStyle.backgroundColor
        ...
        Text {
            ...
            font.pointSize: gaugeStyle.labelSize
            color: value >= (maximumValue - gaugeStyle.alertThreshold) ? gaugeStyle.alertLabelColor : gaugeStyle.labelColor
            antialiasing: true
        }
    }
